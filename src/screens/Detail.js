  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        <Image source={dnaGertrudes} style={styles.imageProfile}></Image>
        <View style={styles.informacoes}>
          <Text style={{ fontSize: 25, color: "#837F7F", fontWeight: "bold" }}>
            Dna. Gertrudes
          </Text>
          <Text style={{ fontSize: 18, color: "#9F9F9F" }}>
            72 anos diarista
          </Text>
          <Text style={{ fontSize: 18, color: "#3B8AEB", maxWidth: "100%" }}>
            Av. Getulio Vargas 369 Joinville
          </Text>
      ...
      <View style={styles.main}>
        <ScrollView style={styles.texto}>
          <Text style={{ fontWeight: "bold", fontSize: 17, color: "#837F7F" }}>
            Serviços
          </Text>
